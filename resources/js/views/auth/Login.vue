    ...
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        <router-link to="/" class="inline-block">
          <div class="flex items-center justify-center gap-2 mb-2">
            ...
            <span class="text-2xl font-bold text-gray-900">AppointHub</span>
          </div>
        </router-link>
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                autocomplete="email"
                :class="[
                  'block w-full pl-10 pr-3 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200',
          ...
          <div>
            <div class="flex items-center justify-between mb-1">
              ...
              <router-link to="/forgot-password" class="text-sm font-medium text-primary-600 hover:text-primary-500 transition-colors">
                Forgot password?
              </router-link>
            </div>
            <div class="relative">
              ...
              <input
                ...
                :class="[
                  'block w-full pl-10 pr-12 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200',
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded transition-all"
              />
          ...
          <div class="grid grid-cols-2 gap-3">
            <button
              type="button"
              class="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200"
            >
      ...
      <div class="mt-8 text-center">
        ...
        <div class="mt-4 flex items-center justify-center gap-4 text-xs text-gray-400">
          <span>© 2026 AppointHub</span>
          <span>•</span>
          <router-link to="/" class="hover:text-primary-600 transition-colors">Home</router-link>
          <span>•</span>
          <router-link to="/contact" class="hover:text-primary-600 transition-colors">Support</router-link>
        </div>
      </div>
    </div>
  </div>
